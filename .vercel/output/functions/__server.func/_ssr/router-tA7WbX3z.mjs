...
//#region node_modules/.nitro/vite/services/ssr/assets/router-tA7WbX3z.js
var router_tA7WbX3z_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-BW1ddCeM.css";
var APP_NAME = "WAVE";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A roleplaying tactical hunt. Walk the island. Cut the board."
			},
			{
			...
			},
			{
				...
				content: "A roleplaying tactical hunt on a hex grid."
			},
			...[],
			...[]
		],
...
var $$splitComponentImporter$1 = () => import("./routes-O9G7j4_B.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-8cB-X7Z7.mjs");
...
var _0002_hunts_default = "create table if not exists hunts (\n  user_id text primary key,\n  save jsonb not null,\n  updated_at timestamptz not null default now()\n);\n";
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_hunts.sql": _0002_hunts_default
		});
...
//#endregion
export { router_tA7WbX3z_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
